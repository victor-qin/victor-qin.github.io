...
export const directions: ResearchDirection[] = [
  {
    ...
    summary: `Centralized air traffic control does not scale to the volume and on-demand
      ...
      is unsafe at any meaningful density. I work on designing protocols and algorithms to optimize strategic traffic flow deconfliction between flights for efficiency and fairness. A recent focus: how do current regulatory frameworks like ASTM F3548-21 break as drone traffic scales?`,
  },
  {
    ...
    summary: `When many strategic agents plan simultaneously, the equilibrium matters more
      ...
      when other agents deviate from the model you assumed for them.`,
  },
  {
    id: 'market-structures',
    title: 'Market Structures and Competition Among Service Providers',
    summary: `Future airspace will be shared by competing service providers, and the market structure they operate under shapes the resulting traffic as much as any control algorithm does. I study how competition, entry, and pricing between providers affect
